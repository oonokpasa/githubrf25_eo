...
%%% iebaltab hh_size n_child_5 n_elder read sick female_head livestock_now area_acre_w drought_flood crop_damage, grpvar(treatment) rowvarlabels format(%9,2f) savecsv("//data3/users3/oonokpasa/My Documents/githubrf25_eo/Stata/Outputs/balance") savetex("//data3/users3/oonokpasa/My Documents/githubrf25_eo/Stata/Outputs/balance") nonote addnote("Significance: ***=.01 **=.05, *=.1") replace
